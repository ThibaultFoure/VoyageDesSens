...
class CategoryFixtures extends Fixture
{
    public const CATEGORIES = [
        [
            ...
            'priceDescription' => '50€, 1 séance, 1 heure',
        ],
        [
            'title' => 'Séances spécifiques',
            'description' => '',
            'priceDescription' => '135€, 3 séances sur 21 jours, 1 heure, suivi d\'une séance par mois si nécessaire 40 euros',
        ],
        [
        ...
        Pendant un mois vous profiterez de 3 séances de réflexologie d\'une heure sur le thème de votre choix :',
            'priceDescription' => '130€, 3 séances sur 21 jours, 1 heure',
        ],
        [
            ...
            'priceDescription' => '75€ par personne, 1 séance, 3 heures, groupe de 4 à 6 personnes, Kits contenants les instruments offerts',
        ],
        [
            'title' => 'Séances enfants (3 à 12 ans)',
            'description' => '',
            'priceDescription' => '40€',
        ],
    ];
